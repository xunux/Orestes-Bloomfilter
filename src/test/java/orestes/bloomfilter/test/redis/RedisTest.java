...
public class RedisTest {
    ...
    public void lua() {
         ...
         * 
         * jedis.del("testcounts"); jedis.del("testbloom"); result = jedis.eval(CBloomFilterRedisBits.SETANDINCR, 2,
         * "testcounts", "testbloom", "4", "2", "100", "105"); System.out.println("Incremented: " + result);
         ...
         * 
         * result = jedis.eval(CBloomFilterRedisBits.SETANDDECR, 2, "testcounts","testbloom", "4", "3", "100", "105",
         * "110"); System.out.println("NonZero: " + result); System.out.println("Least Significant Count Bit: " +
         * jedis.getbit("testcounts", 4*101-1)); System.out.println("Bit in Bloom-Array: " + jedis.getbit("testbloom",
         * 100));
         */
