...
abstract class Striped64 extends Number {
    ...
    /**
     * Holder for the thread-local hash code. The code is initially random, but may be set to a different value upon
     * collisions.
     */
    ...
    /**
     * Static per-thread hash codes. Shared across all instances to reduce ThreadLocal pollution and because adjustments
     * due to collisions in one table are likely to be appropriate for others.
     */
